    ...
    <div className="max-w-2xl space-y-6">
      <div>
        <nav className="flex items-center gap-1.5 text-xs text-[#454652] mb-1">
          ...
          <span className="font-bold text-[#000666]">Edit Campaign</span>
        </nav>
        <h1 className="text-2xl font-extrabold text-[#1a1c1c]">Edit Advertisement</h1>
      </div>

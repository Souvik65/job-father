...
export function AdminJobForm({ job }: { job?: Job }) {
  ...
  const inputClass =
    "w-full border text-slate-800 bg-slate-50 border-slate-400 rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-[#ee6f14] focus:border-transparent transition";
    ...
    >
      ...
      <div className="flex gap-6">
        <label className="flex items-center gap-2 cursor-pointer">
          <input
            ...
            className="rounded border-slate-400 text-[#ee6f14] focus:ring-[#ee6f14] h-4 w-4"
          />
      ...
      <div className="flex justify-end gap-2 pt-4 border-t">
        ...
        <button
          ...
          className="px-6 py-2 bg-[#ee6f14] hover:bg-[#d5580e] text-white rounded-lg font-bold disabled:opacity-50 transition"
        >
